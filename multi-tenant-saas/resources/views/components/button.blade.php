...
@php
$baseClasses = 'inline-flex items-center justify-center gap-3 px-5 py-2.5 text-sm font-medium transition-all duration-200 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-md active:transform active:scale-95';
$variants = [
